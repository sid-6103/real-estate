        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-12 md:gap-8">
          ...
          >
            <div className="flex items-center gap-3 mb-6 group cursor-default">
              <div className="w-8 h-8 border border-gold flex items-center justify-center group-hover:bg-gold/10 transition-colors duration-300">
            ...
            <ul className="space-y-3">
              {["Properties", "About", "Contact"].map((item) => (
                <li key={item}>
                  <Link
                    to={`/${item.toLowerCase()}`}
                    className="text-sm font-body font-light text-[#707076] hover:text-gold hover:translate-x-1 inline-block transition-all duration-300"
                  >
                    {item}
                  </Link>
                </li>
          ...
          >
            ...
            <div className="space-y-3">
              <p className="text-sm font-body font-light text-[#707076] hover:text-[#A1A1A5] transition-colors duration-300 cursor-default">
        ...
        >
          ...
          <div className="flex items-center gap-6">
            {["Privacy", "Terms", "Cookies"].map((item) => (
              <button
                key={item}
                className="text-[11px] font-body font-light text-[#707076] hover:text-gold transition-colors duration-300 tracking-wider uppercase"
              >
                {item}
              </button>
            ))}
